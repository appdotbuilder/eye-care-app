 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Order whereOptikStoreId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Order wherePrescriptionId($value)
...
class Order extends Model
{
    ...
    /**
     * Get the optik store that owns the order.
     */
    ...
    /**
     * Get the prescription associated with the order.
     */
